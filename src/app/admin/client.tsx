...
export default function AdminPage() {
  ...
  async function handleDeleteViatico(id: string) {
    const result = await Swal.fire({
      title: '¿Estás seguro?',
      text: 'Esta acción eliminará el viático y sus archivos asociados. No se puede deshacer.',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#d33',
      cancelButtonColor: '#3085d6',
    ...
    try {
      ...
      Swal.fire('¡Eliminado!', 'El viático ha sido eliminado.', 'success');
      await loadData();
    } catch (e) {
      setError('Error al eliminar viático: ' + (e as Error).message);
      Swal.fire('Error', 'No se pudo eliminar el viático: ' + (e as Error).message, 'error');
    }
  }
