...
function AuthProvider({ children }) {
    ...
    const [verifyingFolder, setVerifyingFolder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
                        ...
                        if (redirectResult) {
                            ...
                            if (isNewUser) {
                                ...
                                try {
                                    ...
                                    const { ensureMyOneDriveFolder } = await __turbopack_context__.A("[project]/src/services/api.ts [app-client] (ecmascript, async loader)");
                        ...
                        "AuthProvider.useEffect.setupAuth": async (user)=>{
                            ...
                            if (user) {
                                ...
                                user.getIdToken().then({
                                    ...
                                    "AuthProvider.useEffect.setupAuth": async (myUser)=>{
                                        if (myUser && myUser.exists) {
                                            if (myUser.estado === 'inactivo') {
                                                ...
                                                const Swal = (await __turbopack_context__.A("[project]/node_modules/sweetalert2/dist/sweetalert2.all.js [app-client] (ecmascript, async loader)")).default;
                                                await Swal.fire({
                                            ...
                                            try {
                                                ...
                                                const newUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMyUser"])();
    ...
    async function signUp(email, password) {
        ...
        try {
            ...
            try {
                setVerifyingFolder(true);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ensureMyOneDriveFolder"])();
            } catch (e) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: [
            children,
            verifyingFolder && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Configurando tu espacio en OneDrive"
                                }, void 0, false, {
                                    fileName: "[project]/src/contexts/AuthContext.tsx",
                                    lineNumber: 295,
                                    columnNumber: 15
...
_s1(AuthProvider, "c76D4aPlO2PL8+EUUA7jg1/aZS0=");
_c = AuthProvider;
var _c;
...
function LoadingProvider({ children }) {
    ...
    const [loadingMessage, setLoadingMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Cargando...');
    const setLoading = (message = 'Cargando...')=>{
...
_s(LoadingProvider, "ECJSfqYUz9wQ5J7RwUTtaluSqoQ=");
_c = LoadingProvider;
function useLoading() {
    _s1();
...
"[project]/src/components/InstallPWA.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InstallPWA() {
    _s();
    const [supportsPWA, setSupportsPWA] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [promptInstall, setPromptInstall] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InstallPWA.useEffect": ()=>{
            const handler = {
                "InstallPWA.useEffect.handler": (e)=>{
                    e.preventDefault();
                    setSupportsPWA(true);
                    setPromptInstall(e);
                }
            }["InstallPWA.useEffect.handler"];
            window.addEventListener('beforeinstallprompt', handler);
            return ({
                "InstallPWA.useEffect": ()=>window.removeEventListener('beforeinstallprompt', handler)
            })["InstallPWA.useEffect"];
        }
    }["InstallPWA.useEffect"], []);
    const onClick = (evt)=>{
...
_s(InstallPWA, "CM/XXHh5uLUf6gCV2dVQdU66jFs=");
_c = InstallPWA;
var _c;
...
//# sourceMappingURL=src_ffd18719._.js.map