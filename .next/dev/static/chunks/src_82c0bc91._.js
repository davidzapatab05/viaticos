...
function AdminPage() {
    ...
    async function handleCleanupAnonymous() {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Completado', `Usuarios eliminados: ${data.deletedUsers}<br>Viáticos eliminados: ${data.deletedViaticos}`, 'success');
            await loadData();
        } catch (e) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Error', e.message || 'Error ejecutando limpieza', 'error');
        }
    }
    async function handleDeleteViatico(id) {
        ...
        try {
            ...
            clearLoading();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Eliminado', 'El viático ha sido eliminado.', 'success');
            await loadData();
        } catch (e) {
            clearLoading();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Error', e.message || 'Error al eliminar viático', 'error');
        }
    }
    ...
    async function executeManualBackup() {
        ...
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["triggerManualBackup"])(backupStartDate, backupEndDate);
            clearLoading();
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire({
    ...
    async function handleTestNotification() {
        if (!("Notification" in window)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sweetalert2$2f$dist$2f$sweetalert2$2e$all$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].fire('Error', 'Este navegador no soporta notificaciones de escritorio', 'error');
            return;
        }
...
_s(AdminPage, "yLQFWjF1dqu3VEDt/lCOHgK81aI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
...
//# sourceMappingURL=src_82c0bc91._.js.map