...
function Layout({ children }) {
    const { user, signOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$AuthContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
        ...
        async function fetchUser() {
            try {
                ...
                if (mounted && res && res.user) {
                    ...
                    setUserName(res.user.name || user?.displayName || user?.email?.split('@')[0] || 'Usuario');
                }
            } catch (e) {
            // ignore
            }
...
function AdminPage() {
    ...
    async function loadData() {
        ...
        try {
            ...
            const superAdminEmail = usersData?.users?.find((u)=>u.role === 'super_admin')?.email?.toLowerCase();
    ...
    async function handleRoleChange(uid, newRole) {
        ...
        try {
            ...
            setError('Error al actualizar rol: ' + e.message);
        } finally{
            setUpdating(null);
        }
    }
    ...
    async function handleCreateFolderChange(uid, crearCarpeta) {
        try {
            ...
            setError('Error al actualizar flag de carpeta: ' + e.message);
        }
    }
    async function handleDeleteUser(uid, email) {
        if (!confirm(`¿Estás seguro de eliminar al usuario ${email}? Esta acción eliminará:\n- El usuario de la base de datos\n- Todos sus viáticos\n- Su carpeta en OneDrive\n\nEsta acción NO se puede deshacer.`)) {
            return;
        }
        try {
    ...
    async function handleCleanupAnonymous() {
        if (!confirm('¿Estás seguro de eliminar todos los usuarios anonymous? Esta acción no se puede deshacer.')) {
            return;
        }
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cleanupAnonymousUsers"])();
            alert(`Limpieza completada: ${result.deletedUsers} usuarios y ${result.deletedViaticos} viáticos eliminados`);
            await loadData(); // Recargar datos
        } catch (e) {
            setError(e.message || 'Error ejecutando limpieza');
        }
    }
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center gap-2",
                                        children: [
                                            oneDriveUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                asChild: true,
                                                variant: "outline",
                                                size: "sm",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__08af20e7._.js.map