...
function AuthProvider({ children }) {
    ...
    const [verifyingFolder, setVerifyingFolder] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
                ...
                if (redirectResult) {
                    ...
                    if (isNewUser) {
                        ...
                        try {
                            ...
                            const { ensureMyOneDriveFolder } = await __turbopack_context__.A("[project]/src/services/api.ts [app-ssr] (ecmascript, async loader)");
                    ...
                    user.getIdToken().then((token)=>{
                        ...
                        if (myUser && myUser.exists) {
                            if (myUser.estado === 'inactivo') {
                                ...
                                const Swal = (await __turbopack_context__.A("[project]/node_modules/sweetalert2/dist/sweetalert2.esm.all.js [app-ssr] (ecmascript, async loader)")).default;
                                await Swal.fire({
                            ...
                            try {
                                ...
                                const newUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMyUser"])();
    ...
    async function signUp(email, password) {
        ...
        try {
            ...
            try {
                setVerifyingFolder(true);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureMyOneDriveFolder"])();
            } catch (e) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AuthContext.Provider, {
        ...
        children: [
            children,
            verifyingFolder && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function LoadingProvider({ children }) {
    ...
    const [loadingMessage, setLoadingMessage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('Cargando...');
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9aae66d0._.js.map